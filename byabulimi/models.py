...
class Farmer(models.Model):
    # Using phone number as primary identifier for ease of field access
    ...
    def __str__(self):
        return f"Farmer: {self.phone_number} ({self.language_code})"
...
class Advice(models.Model):
    query = models.OneToOneField(Query, on_delete=models.CASCADE, primary_key=True) # 1:1 with Query
